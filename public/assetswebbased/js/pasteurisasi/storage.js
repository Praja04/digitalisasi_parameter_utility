$(document).ready(function() {
    ...
    function updateheatingValue() {
        $.ajax({
            url: '../../data/pasteurisasi/storage.php', // File PHP untuk mengambil data terbaru dari MySQL
            dataType: 'json',
            success: function(response) {
                $('#storage').text(response.storage); // Update nilai feed water
                $('#storage1').text(response.storage); // Update nilai feed water
            },
