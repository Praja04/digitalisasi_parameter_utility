$(document).ready(function() {
    ...
    function updateRHTEMPValue() {
        $.ajax({
            url: '../../data/pasteurisasi_line_2/precooling.php', // File PHP untuk mengambil data terbaru dari MySQL
            dataType: 'json',
            success: function(response) {
                $('#precooling').text(response.SuhuPrecooling); // Update nilai feed water
            },
