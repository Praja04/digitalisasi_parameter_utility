$(document).ready(function() {
    ...
    function updateRHTEMPValue() {
        $.ajax({
            url: '../../data/pasteurisasi_line_2/pressureBT2.php', // File PHP untuk mengambil data terbaru dari MySQL
            dataType: 'json',
            success: function(response) {
                $('#pressureBT2').text(response.pressureBT2); // Update nilai feed water
            },
