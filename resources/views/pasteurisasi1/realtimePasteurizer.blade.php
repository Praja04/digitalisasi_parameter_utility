...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetswebbased/css/pasteurisasi/pasteur.css') }}">
    ...
    <script src="{{ asset('assetswebbased/js/pasteurisasi/dataPasteurizer.js') }}"></script>
...
<body>
    ...
    <div class="container">
        ...
        <div class="data">
            <div class="info">
                <img src="{{ asset('assetswebbased/img/pasteurisasi/tampilan.png') }}" alt="logo">
            </div>
            <div class="date">
    ...
    <script>
        ...
        function loadLatestData() {
            ...
            xhr.open('GET', "{{ url('pasteurisasi1/data-realtime') }}", true); // Ganti URL sesuai API-mu
            xhr.onload = function() {
                if (xhr.status === 200) {
