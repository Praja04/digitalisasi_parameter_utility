...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetswebbased/css/st53/TankA.css') }}">
    ...
    <script src="{{ asset('assetswebbased/js/st53/dataA.js') }}"></script>
...
<body>
    ...
    <div class="container">
        ...
        <div class="data">
            <div class="info">
                <img src="{{ asset('assetswebbased/img/st53/tampilanA.png') }}" alt="logo">
            </div>
            <div class="date">
