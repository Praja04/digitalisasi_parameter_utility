...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetswebbased/css/st53/TankB.css') }}">
    ...
    <script src="{{ asset('assetswebbased/js/st53/dataB.js') }}"></script>
...
<body>
    ...
    <div class="container">
        ...
        <div class="data">
            <div class="info">
                <img src="{{ asset('assetswebbased/img/st53/tampilanB.png') }}" alt="logo">
            </div>
            <div class="date">
