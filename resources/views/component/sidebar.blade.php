                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('eng/dashboard/scoring/retail') }}" class="nav-link" data-key="t-analytics">Scoring Mesin Retail</a>
                            </li>
                            <!-- <li class="nav-item">
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="DashboardProses">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item"><a href="{{ url('qc/dashboard/ggaggas') }}" class="nav-link"><i class="mdi mdi-flask"></i> Analisis GGA &
                                                GGAS</a></li>
                                        <li class="nav-item"><a href="{{ url('qc/dashboard/blending/awal') }}" class="nav-link"><i class="mdi mdi-blender"></i> Analisis Blending
                                                Awal</a></li>
                                        <li class="nav-item"><a href="{{ url('qc/dashboard/blending/after') }}" class="nav-link"><i class="mdi mdi-blender-outline"></i> Analisis
                                                Blending After Adjust</a></li>
                                        <li class="nav-item"><a href="{{ url('qc/dashboard/monitoring/turun') }}" class="nav-link"><i class="mdi mdi-chart-line"></i> Monitoring
                                                Turun Blending</a></li>
                                        <li class="nav-item"><a href="{{ url('qc/dashboard/monitoring/storage') }}" class="nav-link"><i class="mdi mdi-database"></i> Monitoring
                                                Storage</a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="Dashboardmikro">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item"><a href="#" class="nav-link"><i class="mdi mdi-database-check-outline"></i> Monitoring
                                                Storage</a></li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboardsPRD">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#" data-bs-target="#sidebarRetail" data-bs-toggle="collapse" role="button" aria-controls="sidebarRetail" class="nav-link" data-key="t-m-tkbm">
                                    Retail
                                </a>
                                <div class="collapse menu-dropdown" id="sidebarRetail">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ url('dashboard/mesin/retail') }}" class="nav-link" data-key="t-analytics"> Downtime Retail</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboardsWarehouse">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('wh/dept_head/dashboard/tkbm') }}" class="nav-link" data-key="t-analytics"> Analytics TKBM</a>
                            </li>
