        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                @if (Session::get('jabatan') === 'dept_head')
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboards">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('eng/dept_head/dashboard') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics Boiler</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('eng/supervisor/dashboard/utility') }}" class="nav-link"
                                        data-key="t-analytics">Analytics Utility</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('eng/dept_head/todo') }}" class="nav-link" data-key="t-analytics">
                                        Todo List ENG </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarDashboardsQC" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarDashboardsQC">
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="DashboardProses">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item"><a href="{{ url('qc/dashboard/ggaggas') }}"
                                                    class="nav-link"><i class="mdi mdi-flask"></i> Analisis GGA &
                                                    GGAS</a></li>
                                            <li class="nav-item"><a href="{{ url('qc/dashboard/blending/awal') }}"
                                                    class="nav-link"><i class="mdi mdi-blender"></i> Analisis Blending
                                                    Awal</a></li>
                                            <li class="nav-item"><a href="{{ url('qc/dashboard/blending/after') }}"
                                                    class="nav-link"><i class="mdi mdi-blender-outline"></i> Analisis
                                                    Blending After Adjust</a></li>
                                            <li class="nav-item"><a href="{{ url('qc/dashboard/monitoring/turun') }}"
                                                    class="nav-link"><i class="mdi mdi-chart-line"></i> Monitoring
                                                    Turun Blending</a></li>
                                            <li class="nav-item"><a
                                                    href="{{ url('qc/dashboard/monitoring/storage') }}"
                                                    class="nav-link"><i class="mdi mdi-database"></i> Monitoring
                                                    Storage</a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="#Dashboardmikro" data-bs-toggle="collapse"
                                        ...
                                        <i class="mdi mdi-chart-scatter-plot"></i> <span
                                            data-key="t-dashboards">Dashboard Mikro</span>
                                    </a>
                                    <div class="collapse menu-dropdown" id="Dashboardmikro">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item"><a href="#" class="nav-link"><i
                                                        class="mdi mdi-blender"></i> Blending After Adjust</a></li>
                                            <li class="nav-item"><a href="#" class="nav-link"><i
                                                        class="mdi mdi-database-check-outline"></i> Monitoring
                                                    Storage</a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="{{ url('qc/dashboard/rm') }}"
                                        data-key="t-analytics">
                                        <i class="mdi mdi-chemical-weapon"></i> <span data-key="t-widgets">Dashboard
                                            RMPM</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarDashboardsPRD" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarDashboardsPRD">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboardsPRD">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('prd/dept_head/dashboard/pasteurisasi1') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics Pasteurisasi 1</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('prd/dept_head/dashboard/pasteurisasi2') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics Pasteurisasi 2</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('prd/dept_head/menu_retail') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics Retail</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('prd/dashboard/separator') }}" class="nav-link"
                                        data-key="t-analytics">
                                        Separator
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarDashboardsWarehouse" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarDashboardsWarehouse">
                            <i class="mdi mdi-home-group-plus"></i> <span data-key="t-dashboards">Dashboard
                                Warehouse</span>
                        </a>
                        <div class="collapse menu-dropdown" id="sidebarDashboardsWarehouse">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('wh/dept_head/dashboard') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics P2H </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('wh/dept_head/dashboard/tkbm') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics TKBM</a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarMesin" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarMesin">
                            <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-authentication">Data
                                Mesin</span>
                        </a>
                        <div class="collapse menu-dropdown" id="sidebarMesin">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="#sidebarBoiler" data-bs-toggle="collapse"
                                        role="button" aria-expanded="false" aria-controls="sidebarBoiler">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarBoiler">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('boiler/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('boiler/realtime') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarDailytank">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('daily-tank/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('daily-tank/realtime') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarDissolver">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('dissolver/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('dissolver/realtime') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarGlucose">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('glucose/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('glucose/realtime') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarOlahsari">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('olahsari/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('olahsari/realtime') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarPasteur1">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('pasteurisasi1/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('pasteurisasi1/realtime-pasteurizer') }}"
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarPasteur2">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('pasteurisasi2/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('pasteurisasi2/realtime') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarStk400">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('stk400/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('stk400/realtime') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarSt53">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ url('st53/datatren') }}" class="nav-link"
                                                    data-key="t-analytics">
                                                    Analytics Data Trend
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('st53/realtime-tankA') }}" class="nav-link"
                                                    data-key="t-crm">
                                                    Dashboard Realtime
                                                </a>
                                            </li>
                ...
                @elseif(Session::get('jabatan') === 'supervisor' && Session::get('departemen') === 'engineering')
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboards">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('eng/supervisor/dashboard') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics Boiler</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('eng/supervisor/dashboard/utility') }}" class="nav-link"
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('eng/dept_head/todo') }}" class="nav-link"
                                        data-key="t-analytics"> Todo List ENG </a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarDashboardsUtility" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarDashboardsUtility">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboardsUtility">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('eng/supervisor/data/utility') }}" class="nav-link"
                                        data-key="t-analytics"> Data Utility</a>
                                </li>
                ...
                @elseif(Session::get('jabatan') === 'supervisor' && Session::get('departemen') === 'qc')
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboardsQC">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('qc/supervisor/dashboard') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics Pasteurisasi 1</a>
                                </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboardsPRD">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('prd/supervisor/dashboard') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics Pasteurisasi 1</a>
                                </li>
                ...
                @elseif(Session::get('jabatan') === 'supervisor' && Session::get('departemen') === 'produksi')
                    ...
                    <!-- Dashboard Pasteurisasi -->
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarPasteurisasi" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarPasteurisasi">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarPasteurisasi">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('prd/supervisor/dashboard/pasteurisasi1') }}" class="nav-link"
                                        data-key="t-analytics">
                                        <i class="mdi mdi-chart-line"></i> Pasteurisasi 1
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('prd/supervisor/dashboard/pasteurisasi2') }}" class="nav-link"
                                        data-key="t-analytics">
                    ...
                    <!-- Dashboard Retail -->
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarRetail" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarRetail">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarRetail">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ route('prd.menu_retail') }}" class="nav-link"
                                        data-key="t-analytics">
                ...
                @elseif(Session::get('jabatan') === 'supervisor' && Session::get('departemen') === 'warehouse')
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarDashboardswarehouse" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarDashboardswarehouse">
                            <i class="mdi mdi-check-circle"></i> <span data-key="t-dashboards">Dashboard
                                Warehouse</span>
                        </a>
                        <div class="collapse menu-dropdown" id="sidebarDashboardswarehouse">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{ url('wh/supervisor/dashboard') }}" class="nav-link"
                                        data-key="t-analytics"> Analytics P2H</a>
                                </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#P2hForeman" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="P2hForeman">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#RegistrasiP2Hforeman" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="RegistrasiP2Hforeman">
                            <i class="mdi mdi-package-variant"></i> <span data-key="t-dashboards">Registrasi Unit
                                P2H</span>
                        </a>
                            ...
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="{{ url('wh/forklift-registration') }}">
                                        <i class="mdi mdi-card-account-details"></i> <span
                                            data-key="t-widgets">Registrasi Forklift</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="{{ url('wh/pallet-mover-registration') }}">
                                        <i class="mdi mdi-card-account-details"></i> <span
                                            data-key="t-widgets">Registrasi Pallet Mover</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                @elseif(Session::get('jabatan') === 'foreman' && Session::get('departemen') === 'qc')
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ url('qc/foreman/dashboard') }}">
                            <i class="mdi mdi-card-account-details"></i> <span data-key="t-widgets">Form input
                                AfterCooling</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ url('qc/operator/list') }}">
                            <i class="mdi mdi-card-account-details"></i> <span data-key="t-widgets">List Data
                                AfterCooling</span>
                        </a>
                    </li>
                @elseif(Session::get('jabatan') === 'foreman' && Session::get('departemen') === 'engineering')
                    ...
                    @if (Session::get('bagian') === 'Engineering Maintenance & Improvement')
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ url('wh/foreman/dashboard') }}">
                                <i class="mdi mdi-card-account-details"></i> <span data-key="t-widgets">Foreman
                                    Dashboard</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#P2hForeman" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="P2hForeman">
                                <i class="mdi mdi-package-variant"></i> <span data-key="t-dashboards">P2H
                                    Online</span>
                            </a>
                            <div class="collapse menu-dropdown" id="P2hForeman">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="{{ url('wh/foreman/form/p2h') }}">
                                            <i class="mdi mdi-card-account-details"></i> <span
                                                data-key="t-widgets">Form P2H</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="{{ url('wh/foreman/detail/p2h') }}">
                                            <i class="mdi mdi-card-account-details"></i> <span
                                                data-key="t-widgets">Data P2H</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ url('eng/foreman/dashboard') }}">
                            <i class="mdi mdi-card-account-details"></i> <span data-key="t-widgets">Dashboard
                                Utility</span>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                @elseif(Session::get('jabatan') === 'foreman' && Session::get('departemen') === 'produksi')
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ url('prd/operator/history') }}">
                            <i class="mdi mdi-card-account-details"></i> <span data-key="t-widgets">List History
                                Batch</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ url('prd/operator/status_running') }}">
                            <i class="mdi mdi-card-account-details"></i> <span data-key="t-widgets">Status Running
                                Produksi</span>
                        </a>
                    </li>
                ...
                @elseif(Session::get('jabatan') === 'operator' && Session::get('departemen') === 'produksi')
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ url('prd/operator/form_retail') }}">
                            <i class="mdi mdi-card-account-details"></i> <span data-key="t-widgets">Form target
                                Retail</span>
                        </a>
                    </li>
                    <li class="nav-item">
