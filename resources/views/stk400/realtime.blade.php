...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetswebbased/css/stk400/style.css') }}">
    ...
    <script src="{{ asset('assetswebbased/js/stk400/data.js') }}"></script>
    <script src="{{ asset('assetswebbased/js/stk400/date.js') }}"></script>
...
<body>
    <label>
        <div class="slide">
            ...
            <ul>
                <li><a href="{{ url('stk400/datatren') }}"><i class="fas fa-tv"></i>Back to Data Trend</a></li>
    ...
    <div class="container">
        ...
        <div class="data">
            <div class="info">
                <img src="{{ asset('assetswebbased/img/stk400/tampilan.png') }}" alt="logo">
            </div>
