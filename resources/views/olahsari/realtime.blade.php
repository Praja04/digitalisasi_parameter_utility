...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetswebbased/css/olahsari/style.css') }}">
    ...
    <script src="{{ asset('assetswebbased/js/olahsari/data.js') }}"></script>
    <script src="{{ asset('assetswebbased/js/olahsari/date.js') }}"></script>
    <link href="{{ asset('material/assets/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />

    <script>
        var BASE_URL = "{{ url('olahsari') }}";
    </script>
...
<body>
    <label>
        <div class="slide">
            ...
            <ul>
                <li><a href="{{ url('olahsari/datatren') }}"><i class="fas fa-tv"></i>Back to Data Trend</a></li>
    ...
    <div class="container">
        ...
        <div class="data">
            <div class="data">
                <div class="info">
                    <img src="{{ asset('assetswebbased/img/olahsari/tampilan.png') }}" alt="logo">
                </div>
                <div class="date">
