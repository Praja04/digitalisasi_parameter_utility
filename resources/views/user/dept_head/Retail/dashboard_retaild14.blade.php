        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Produksi - Retail Filling D14</h4>
...
<script>
    ...
    function fetchdataFilter() {
        ...
        let startUrl = useRealtimeUrl ? "{{ url('retail/d14/mesin/start/realtime') }}" : "{{ url('retail/d14/mesin/start') }}";
        let stopUrl = useRealtimeUrl ? "{{ url('retail/d14/mesin/stop/realtime') }}" : "{{ url('retail/d14/mesin/stop') }}";

        $.ajax({
            url: "{{ url('retail/d14/output/performance') }}",
            type: "GET",
            dataType: "json",
        ...
        $.ajax({
            url: "{{url('retail/d14/mesin-stop-periods')}}",
            method: 'GET',
            dataType: "json",
        ...
        $.ajax({
            url: "{{url('retail/d14/average-main-speed')}}",
            method: 'GET',
            dataType: "json",
            success: function(response) {
        ...
        $.ajax({
            url: "{{url('retail/d14/output/performance/all_shift')}}",
            method: 'GET',
            data: data,
            success: function(response) {
        ...
        $.ajax({
            url: "{{url('retail/d14/output/gagal/filling')}}",
            method: 'GET',
            data: data,
            success: function(response) {
                response.forEach(item => {
