        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Produksi - Retail Filling D3</h4>
...
<script>
    $(document).ready(function() {
        ...
        function get_data() {
            ...
            $.ajax({
                url: "{{url('retail/d3/mesin-stop-periods')}}",
                method: 'GET',
                // data: data,
                dataType: "json",
            ...
            $.ajax({
                url: "{{url('retail/d3/average-main-speed')}}",
                method: 'GET',
                // data: data,
                dataType: "json",
                success: function(response) {
        ...
        function fetchdataFilter() {
            ...
            let startUrl = useRealtimeUrl ? "{{ url('retail/d3/mesin/start/realtime') }}" : "{{ url('retail/d3/mesin/start') }}";
            ...
            $.ajax({
                url: "{{url('retail/d3/output/performance/all_shift')}}",
                method: 'GET',
                data: data,
                success: function(response) {
            ...
            $.ajax({
                url: "{{url('retail/d3/output/gagal/filling')}}",
                method: 'GET',
                data: data,
                success: function(response) {
                    // response.forEach(item => {
