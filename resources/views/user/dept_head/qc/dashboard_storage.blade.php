            ...
            <div class="col-xxl-12 mx-auto">
                <div class="card card-height-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Monitoring Storage Disposition Analysis</h4>
                    </div>
                    <div class="card-body">
                        <div id="chart-disposition-monitoring" class="apex-charts" style="min-height: 350px;"></div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        function fetchBlendingData(startDate = null, endDate = null) {
            let url = "http://10.11.10.130:8081/public/api/monitoring/storage/analysis";
        ...
        function fetchDispositionData(startDate = null, endDate = null) {
            let url = "http://10.11.10.130:8081/public/api/monitoring/storage/disposition-analysis";
            if (startDate && endDate) {
                url += `?start_date=${startDate}&end_date=${endDate}`;
            }
            ...
            $.getJSON(url, function(response) {
                ...
                $('#chart-disposition-monitoring').html('');
                new ApexCharts(document.querySelector('#chart-disposition-monitoring'), options).render();
            });
        }
