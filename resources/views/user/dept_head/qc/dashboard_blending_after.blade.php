        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Blending After Adjust</h4>
            ...
            <div class="col-xxl-12 mx-auto">
                <div class="card card-height-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">Blending After Adjust Disposition Analysis</h4>
                    </div>
                    <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        function fetchBlendingData(startDate = null, endDate = null) {
            let url = "http://10.11.10.130:8081/public/api/blending/after/analysis";
        ...
        function fetchDispositionData(startDate = null, endDate = null) {
            let url = "http://10.11.10.130:8081/public/api/blending/after/disposition-analysis";
            if (startDate && endDate) {
                url += `?start_date=${startDate}&end_date=${endDate}`;
            }
