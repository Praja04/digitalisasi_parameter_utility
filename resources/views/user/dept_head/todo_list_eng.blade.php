    ...
    <div class="container-fluid">
        <div
                ...
                <div class="p-4 d-flex flex-column h-100">
                    <div class="mb-3">
                        <button
                            ...
                            <i
                                class="ri-add-line align-bottom"></i>
                            Add Project
                        </button>
                    </div>
                        ...
                        <ul
                            ...
                            <li>
                                <a
                                    data-bs-toggle="collapse"
                                    href="#skoteAdmin"
                                    class="nav-link fs-14">Skote Admin & Dashboard</a>
                                <div
                                    class="collapse"
                                    id="skoteAdmin">
                                    <ul
            ...
            <div class="file-manager-content w-100 p-4 pb-0">
                <div class="row mb-4">
                    <div
                        class="col-auto order-1 d-block d-lg-none">
                        <button
                            type="button"
                            class="btn btn-soft-success btn-icon btn-sm fs-16 file-menu-btn">
                            <i
                                class="ri-menu-2-fill align-bottom"></i>
                        </button>
                    </div>
                    <div
                        class="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                        <h5 class="fw-semibold mb-0">
                            Velzon Admin & Dashboard
                            <span
                                class="badge bg-primary align-bottom ms-2">v2.0.0</span>
                        </h5>
                    </div>

                    <div
                        class="col-auto order-2 order-sm-3 ms-auto">
                        <div class="hstack gap-2">
                            <div
                                ...
                                <button
                                    ...
                                    <i
                                        class="ri-arrow-go-forward-line"></i>
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <table
                                ...
                                <tbody id="task-listp">
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="15" id="todo15"> <label class="form-check-label" for="todo15">Added Select2</label> </div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="avatar-group flex-nowrap"><a href="javascript: void(0);" class="avatar-group-item" data-img="assets/images/users/avatar-1.jpg" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Curtis Saenz"> <img src="assets/images/users/avatar-1.jpg" alt="" class="rounded-circle avatar-xxs"> </a><a href="javascript: void(0);" class="avatar-group-item" data-img="assets/images/users/avatar-3.jpg" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="John Robles"> <img src="assets/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xxs"> </a></div>
                                        </td>
                                        <td>23 Apr, 2022</td>
                                        ...
                                        <td>
                                            <div class="hstack gap-2"> <button class="btn btn-sm btn-soft-danger remove-list" data-bs-toggle="modal" data-bs-target="#removeTaskItemModal" data-remove-id="15"><i class="ri-delete-bin-5-fill align-bottom"></i></button> <button class="btn btn-sm btn-soft-info edit-list" data-bs-toggle="modal" data-bs-target="#createTask" data-edit-id="15"><i class="ri-pencil-fill align-bottom"></i></button> </div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            <div class="modal-content">
                <div class="modal-header p-3 bg-soft-success">
                    ...
                    <button
                        ...
                        id="addProjectBtn-close"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form
                        autocomplete="off"
                        class="needs-validation createProject-form"
                        novalidate>
                        <div class="mb-4">
                            <label
                                for="projectname-input"
    ...
    <div
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-soft-success">
                    <h5 class="modal-title" id="createTaskLabel">
                        Create Task
                    </h5>
                    <button
                        type="button"
                ...
                <div class="modal-body">
                    <div
                        id="task-error-msg"
                        class="alert alert-danger py-2"></div>
                        ...
                        <div class="mb-3 position-relative">
                            ...
                            <div class="select-element">
                                <button
                                    ...
                                    <span>Assigned To<b
                                            id="total-assignee"
                                            class="mx-1">0</b>Members</span>
                                    <i class="mdi mdi-chevron-down"></i>
                                </button>
                                <div class="dropdown-menu w-100">
                                    <div
                                        data-simplebar
                                        style="max-height: 141px">
...
<script src="{{ asset('material/assets/js/pages/todo.init.js') }}"></script>
