                ...
                <div class="col-md-6">
                    <div class="card clickable card-unit forklift-card" data-unit="Forklift">
                        <div class="card-body text-center">
                            ...
                            <img src="{{ asset('assets/images/forklift.jpg') }}" alt="gambar" height="150"
                ...
                <div class="col-md-6">
                    <div class="card clickable card-unit pallet-card" data-unit="Pallet Mover">
                        <div class="card-body text-center">
                            ...
                            <img src="{{ asset('assets/images/pallet_mover.jpg') }}" alt="gambar" height="150"
                                style="border-radius: 20px;">
                            <p class="text-muted">Klik untuk pemeriksaan</p>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="nomor_unit" class="form-select">
                                            ...
                                            @foreach ($data_forklift as $forklift)
                                                <option value="{{ $forklift->nomor_unit }}">{{ $forklift->nomor_unit }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <label class="radio-label">
                                                    <input type="radio" name="{{ $key }}" value="0"> Tidak
                                                    OK
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="nomor_unit" class="form-select">
                                            ...
                                            @foreach ($data_pallet as $pallet)
                                                <option value="{{ $pallet->nomor_unit }}">{{ $pallet->nomor_unit }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
