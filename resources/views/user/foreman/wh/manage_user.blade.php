                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="jabatan" name="jabatan" value="operator" readonly />
        ...
        $("#list-view-button").on("click", function() {
            ...
            $.ajax({
                ...
                success: function(users) {
                    ...
                    users.forEach(user => {
                        if (user.departemen !== 'warehouse') return;
        ...
        function loadUsers() {
            $.ajax({
                ...
                success: function(users) {
                    let userList = '';
                    users.forEach(user => {
                        if (user.departemen !== 'warehouse') return; // Hanya tampilkan user dari departemen warehouse
