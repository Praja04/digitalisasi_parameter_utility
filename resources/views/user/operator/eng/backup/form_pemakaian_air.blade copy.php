            ...
            <div class="modal-body">
                <form id="formTambahPemakaianAir" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="number" step="0.01" id="pemakaian_liter_awal" placeholder="Masukkan nilai dalam liter...">
                    </div>
                    <div class="mb-3">
                        <label for="pemakaian_liter_akhir" class="form-label">Pemakaian Air Akhir (Liter)<span class="text-danger">*</span></label>
                        <input class="form-control" type="number" step="0.01" id="pemakaian_liter_akhir" placeholder="Masukkan nilai dalam liter...">
                    </div>
                    <div class="mb-3">
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".update-button", function() {
            ...
            if (item) {
                ...
                $("#pemakaian_liter_awal").val(item.pemakaian_awal);
                $("#pemakaian_liter_akhir").val(item.pemakaian_akhir);
                $("#jenis_pemakaian").val(item.jenis_pemakaian);
