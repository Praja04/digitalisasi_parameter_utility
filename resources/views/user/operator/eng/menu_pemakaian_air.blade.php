            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card ribbon-box right overflow-hidden">
                    <div class="card-body text-center p-4">
                        ...
                        <div class="mt-4">
                            <a href="{{url('eng/operator/pemakaian_air')}}" class="btn btn-light w-100">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card ribbon-box right overflow-hidden">
                    <div class="card-body text-center p-4">
                        ...
                        <div class="mt-4">
                            <a href="{{url('eng/operator/data_air')}}" class="btn btn-light w-100">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            </div>
