...
class RetailD7Controller extends Controller
{
    ...
    public function durasiStartMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d7::getShiftSchedule($carbonDate);
            $durasi = retail_d7::getStartMesinDurasiPerShift($tanggalStr);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d7::getShiftSchedule($carbonDate);
            $durasi = retail_d7::getOffMesinDurasiPerShift($tanggalStr);
