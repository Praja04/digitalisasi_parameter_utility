...
use App\Models\Retail\retail_d7;
use App\Models\Retail\retail_d7_nozzle1;
use App\Models\Retail\retail_d7_nozzle2;
use Illuminate\Http\Request;
use Carbon\Carbon;
class RetailD7Controller extends Controller
{
    //
    //
    // buatkan fungsi ambil 1 data terakhir dari tabel retail_d7
    public function getLastData()
    {
        // Ambil data terakhir dari tabel retail_d7
        $data = retail_d7::orderBy('ts', 'desc')->first();
    ...
    public function getNozzleCount(Request $request)
    {
        ...
        $shiftCounts = retail_d7_nozzle1::getNozzleCountPerShift($dates);
        $shiftCounts2 = retail_d7_nozzle2::getNozzleCountPerShift($dates);
    ...
    public function getMesinStopPeriods(Request $request)
    {
        ...
        $periods = retail_d7::getMesinStopPeriods($filter, $start, $end);
    ...
    public function getTotalMesinRunningMinutes(Request $request)
    {
        ...
        $uptime = retail_d7::getTotalMesinRunningMinutesByShift($filter, $start, $end);
    ...
    public function getTotalMesinStopMinutes(Request $request)
    {
        ...
        // Ambil total menit dan uptime untuk masing-masing shift
        $uptime = retail_d7::getTotalMesinDowntimeByShift($filter, $start, $end);
    ...
    public function getperformanceOutput(Request $request)
    {
        ...
        $data = retail_d7::getPerformanceOutput($tanggal);
    ...
    public function getperformanceOutputAllShift(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d7::getAllShiftPerformanceOutput($tanggal);
    ...
    public function getGagalFilling(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d7::getPerformanceGagalFilling($tanggal);
    ...
    public function durasiStartMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d7::getStartMesinDurasiPerShift($today);
            ...
            $durasi = retail_d7::getStartMesinDurasiPerShift($date);
            ...
            while ($mulai->lte($selesai)) {
                ...
                $durasi = retail_d7::getStartMesinDurasiPerShift($tanggal);
    ...
    public function durasiOffMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d7::getOffMesinDurasiPerShift($hariIni);
            ...
            $durasi = retail_d7::getOffMesinDurasiPerShift($tgl);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            $now = Carbon::now('Asia/Jakarta');
            $tanggal = $now->toDateString(); // hari ini WIB
            $durasi = retail_d7::getOffMesinDurasiPerShift($tanggal);
