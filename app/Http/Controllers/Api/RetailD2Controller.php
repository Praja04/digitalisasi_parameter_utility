...
class RetailD2Controller extends Controller
{
    ...
    public function durasiStartMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d2::getStartMesinDurasiRealtime($tanggalStr);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d2::getShiftSchedule($carbonDate);
            $durasi = retail_d2::getOffMesinDurasiRealtime($tanggalStr);
    ...
    public function durasiOffMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $hasil = retail_d2::getOffMesinDurasiPerShift($tanggal);
            ...
            while ($start->lte($end)) {
                ...
                $periode[$tanggal] = retail_d2::getOffMesinDurasiPerShift($tanggal);
                $start->addDay();
            }
    ...
    public function durasiStartMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            $tanggal = Carbon::now()->toDateString();
            $hasil = retail_d2::getStartMesinDurasiPerShift($tanggal);
        } elseif ($filter === 'tanggal' && $request->filled('tanggal')) {
            $tanggal = Carbon::parse($request->input('tanggal'))->toDateString();
            $hasil = retail_d2::getStartMesinDurasiPerShift($tanggal);
        } elseif ($filter === 'range' && $request->filled(['start_date', 'end_date'])) {
            ...
            while ($start->lte($end)) {
                $tanggal = $start->toDateString();
                $periode[$tanggal] = retail_d2::getStartMesinDurasiPerShift($tanggal);
                $start->addDay();
            }
