...
class RetailD6Controller extends Controller
{
    ...
    public function durasiStartMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d6::getShiftSchedule($carbonDate);
            $durasi = retail_d6::getStartMesinDurasiPerShift($tanggalStr);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d6::getShiftSchedule($carbonDate);
            $durasi = retail_d6::getOffMesinDurasiPerShift($tanggalStr);
