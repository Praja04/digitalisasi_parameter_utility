...
use App\Models\Retail\retail_d6;
use App\Models\Retail\retail_d6_nozzle1;
use App\Models\Retail\retail_d6_nozzle2;
use Illuminate\Http\Request;
use Carbon\Carbon;

class RetailD6Controller extends Controller
{
    //
    // buatkan fungsi ambil 1 data terakhir dari tabel retail_d6
    public function getLastData()
    {
        // Ambil data terakhir dari tabel retail_d6
        $data = retail_d6::orderBy('ts', 'desc')->first();
    ...
    public function getNozzleCount(Request $request)
    {
        ...
        $shiftCounts = retail_d6_nozzle1::getNozzleCountPerShift($dates);
        $shiftCounts2 = retail_d6_nozzle2::getNozzleCountPerShift($dates);
    ...
    public function getMesinStopPeriods(Request $request)
    {
        ...
        $periods = retail_d6::getMesinStopPeriods($filter, $start, $end);
    ...
    public function getTotalMesinRunningMinutes(Request $request)
    {
        ...
        $uptime = retail_d6::getTotalMesinRunningMinutesByShift($filter, $start, $end);
    ...
    public function getTotalMesinStopMinutes(Request $request)
    {
        ...
        // Ambil total menit dan uptime untuk masing-masing shift
        $uptime = retail_d6::getTotalMesinDowntimeByShift($filter, $start, $end);
    ...
    public function getperformanceOutput(Request $request)
    {
        ...
        $data = retail_d6::getPerformanceOutput($tanggal);
    ...
    public function getperformanceOutputAllShift(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d6::getAllShiftPerformanceOutput($tanggal);
    ...
    public function getGagalFilling(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d6::getPerformanceGagalFilling($tanggal);
    ...
    public function durasiStartMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d6::getStartMesinDurasiPerShift($today);
            ...
            $durasi = retail_d6::getStartMesinDurasiPerShift($date);
            ...
            while ($mulai->lte($selesai)) {
                ...
                $durasi = retail_d6::getStartMesinDurasiPerShift($tanggal);
    ...
    public function durasiOffMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d6::getOffMesinDurasiPerShift($hariIni);
            ...
            $durasi = retail_d6::getOffMesinDurasiPerShift($tgl);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            $now = Carbon::now('Asia/Jakarta');
            $tanggal = $now->toDateString(); // hari ini WIB
            $durasi = retail_d6::getOffMesinDurasiPerShift($tanggal);
