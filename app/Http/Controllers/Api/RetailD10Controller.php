...
use App\Models\Retail\retail_d10;
use Illuminate\Http\Request;
use Carbon\Carbon;
class RetailD10Controller extends Controller
{
    //
    //
    // buatkan fungsi ambil 1 data terakhir dari tabel retail_d10
    public function getLastData()
    {
        // Ambil data terakhir dari tabel retail_d10
        $data = retail_d10::orderBy('ts', 'desc')->first();
    ...
    public function getMesinStopPeriods(Request $request)
    {
        ...
        $periods = retail_d10::getMesinStopPeriods($filter, $start, $end);
    ...
    public function getTotalMesinRunningMinutes(Request $request)
    {
        ...
        $uptime = retail_d10::getTotalMesinRunningMinutesByShift($filter, $start, $end);
    ...
    public function getTotalMesinStopMinutes(Request $request)
    {
        ...
        // Ambil total menit dan uptime untuk masing-masing shift
        $uptime = retail_d10::getTotalMesinDowntimeByShift($filter, $start, $end);
    ...
    public function getperformanceOutput(Request $request)
    {
        ...
        $data = retail_d10::getPerformanceOutput($tanggal);
    ...
    public function getperformanceOutputAllShift(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d10::getAllShiftPerformanceOutput($tanggal);
    ...
    public function getGagalFilling(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d10::getPerformanceGagalFilling($tanggal);
    ...
    public function durasiStartMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d10::getStartMesinDurasiPerShift($today);
            ...
            $durasi = retail_d10::getStartMesinDurasiPerShift($date);
            ...
            while ($mulai->lte($selesai)) {
                ...
                $durasi = retail_d10::getStartMesinDurasiPerShift($tanggal);
    ...
    public function durasiOffMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d10::getOffMesinDurasiPerShift($hariIni);
            ...
            $durasi = retail_d10::getOffMesinDurasiPerShift($tgl);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            $now = Carbon::now('Asia/Jakarta');
            $tanggal = $now->toDateString(); // hari ini WIB
            $durasi = retail_d10::getOffMesinDurasiPerShift($tanggal);
