...
class RetailD3Controller extends Controller
{
    ...
    public function durasiStartMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d3::getShiftSchedule($carbonDate);
            $durasi = retail_d3::getStartMesinDurasiPerShift($tanggalStr);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d3::getShiftSchedule($carbonDate);
            $durasi = retail_d3::getOffMesinDurasiPerShift($tanggalStr);
