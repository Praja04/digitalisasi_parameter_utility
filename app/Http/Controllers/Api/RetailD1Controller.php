...
class RetailD1Controller extends Controller
{
    ...
    public function durasiStartMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d1::getShiftSchedule($carbonDate);
            $durasi = retail_d1::getStartMesinDurasiPerShift($tanggalStr);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $shifts = retail_d1::getShiftSchedule($carbonDate);
            $durasi = retail_d1::getOffMesinDurasiPerShift($tanggalStr);
