...
use App\Models\Retail\retail_d1;
use App\Models\Retail\retail_d1_nozzle1;
use App\Models\Retail\retail_d1_nozzle2;
use Illuminate\Http\Request;
use Carbon\Carbon;
class RetailD1Controller extends Controller
{
    //
    //
    // buatkan fungsi ambil 1 data terakhir dari tabel retail_d1
    public function getLastData()
    {
        // Ambil data terakhir dari tabel retail_d1
        $data = retail_d1::orderBy('ts', 'desc')->first();
    ...
    public function getNozzleCount(Request $request)
    {
        ...
        $shiftCounts = retail_d1_nozzle1::getNozzleCountPerShift($dates);
        $shiftCounts2 = retail_d1_nozzle2::getNozzleCountPerShift($dates);
    ...
    public function getMesinStopPeriods(Request $request)
    {
        ...
        $periods = retail_d1::getMesinStopPeriods($filter, $start, $end);
    ...
    public function getTotalMesinRunningMinutes(Request $request)
    {
        ...
        $uptime = retail_d1::getTotalMesinRunningMinutesByShift($filter, $start, $end);
    ...
    public function getTotalMesinStopMinutes(Request $request)
    {
        ...
        // Ambil total menit dan uptime untuk masing-masing shift
        $uptime = retail_d1::getTotalMesinDowntimeByShift($filter, $start, $end);
    ...
    public function getperformanceOutput(Request $request)
    {
        ...
        $data = retail_d1::getPerformanceOutput($tanggal);
    ...
    public function getperformanceOutputAllShift(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d1::getAllShiftPerformanceOutput($tanggal);
    ...
    public function getGagalFilling(Request $request)
    {
        ...
        // Ambil data berdasarkan tanggal yang sudah diset
        $data = retail_d1::getPerformanceGagalFilling($tanggal);
    ...
    public function durasiStartMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d1::getStartMesinDurasiPerShift($today);
            ...
            $durasi = retail_d1::getStartMesinDurasiPerShift($date);
            ...
            while ($mulai->lte($selesai)) {
                ...
                $durasi = retail_d1::getStartMesinDurasiPerShift($tanggal);
    ...
    public function durasiOffMesinPerShift(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            ...
            $durasi = retail_d1::getOffMesinDurasiPerShift($hariIni);
            ...
            $durasi = retail_d1::getOffMesinDurasiPerShift($tgl);
    ...
    public function durasiStopMesinPerShiftRealtime(Request $request)
    {
        ...
        if ($filter === 'realtime') {
            $now = Carbon::now('Asia/Jakarta');
            $tanggal = $now->toDateString(); // hari ini WIB
            $durasi = retail_d1::getOffMesinDurasiPerShift($tanggal);
